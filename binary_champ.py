...
def import_data(latest_year, excluded_year):
    ...
    Returns:
    - X_year (list): List of data arrays for each year (excluding the excluded_year).
...
def import_random_data(latest_year, excluded_year):
    ...
    Returns:
    - X_year (list): List of data arrays for each year (excluding the excluded_year) with added random samples.
    - y (list): List of target values corresponding to the teams and years.
    """
...
def import_advanced_data(latest_year, excluded_year):
    ...
    Returns:
    - X_year (list): List of advanced data arrays for each year (excluding the excluded_year).
    - y (list): List of target values corresponding to the teams and years.
    """
